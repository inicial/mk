...
{
    public class BillSettingViewModel: ViewModelBase, IBillSetting
    {
        ...
        public BillSettingViewModel()
        {
            
        }

        public BillSettingViewModel(VoucherViewModel voucherViewModel, UpdateVoucher updateVoucher)
        {
