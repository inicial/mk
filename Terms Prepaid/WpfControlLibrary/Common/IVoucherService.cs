...
namespace WpfControlLibrary.Common
{
    public interface IVoucherService
    {
        ...
        void CruiseBonusesAndServicesAdd(int dlKey, int[] id);
        ...
        DateTime GetBronirDate(string dgCode);
        DateTime GetDocumentQueryDate(string dgCode);
        DateTime GetDocumentGetDate(string dgCode);
        bool GetBronirDocumentDates(string dgCode, ref DateTime BronirDT, ref DateTime DocQueryDT, ref DateTime DocGetDT);
        DataRow GetShipName(int clId, string shipCode);
        DataRow GetShipInfo2(int dlKey);
        DataRow GetVisaInfo2(int dlKey);
//        DataRow GetCruiseTarif(int dlKey);
        ...
        DataTable GetCanceledVisas(string dgcode);
        ...
        DataTable GetNoBonusesAndServices(int dlKey);
