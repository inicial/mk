...
namespace WpfControlLibrary.Common
{
    public interface IRequestJournalService
    {
        ...
        int GetLockingCompanionsCount();
        int GetExistsCompanionsCount();
        ...
        DataTable GetRequests(DateTime? dateBegin, DateTime? dateEnd, string senderAddress, int? usKey, int[] problems, int[] statuses, int[] subStatuses, bool senderAddressContains);
        ...
        DataTable GetManagerWithProblemRequests();
    }
}
