...
namespace WpfControlLibrary.Model.Common
{
    public class UserBase : Data
    {
        ...
        public UserBase(int key, string name)
        {
            Key = key;
            Name = name;
        }
    ...
    public class User : UserBase
    {
        ...
        public User(int key, string name, string email, int? phone, string fName, string sName, string mName, string job) : base(key, name)
        {
            Email = email;
            Phone = phone;
            FName = fName;
