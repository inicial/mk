...
namespace terms_prepaid.UserControls
{
    public partial class ucMessages : UserControl
    {
        ...
        private const string selectMessageMaster1 =
            "select HI_DGCOD,HI_DATE ,case when HI_WHO in('www.mcruises.ru' ,'')then 'Клиент' else HI_WHO end  as HI_WHO,HI_TEXT,HI_MOD from History where [HI_MOD] in('MTC','www','MCO')  and [HI_DGCOD]=@p2 order by HI_DATE";
