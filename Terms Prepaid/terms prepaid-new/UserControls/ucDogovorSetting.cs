...
namespace terms_prepaid.UserControls
{
    ...
    public partial class ucDogovorSetting : UserControl, IDogovorSetting
    {
        ...
        public ucDogovorSetting(UpdateVaucher updateVaucher, VaucherViewModel vaucherViewModel)
        {
            ...
            if (vaucherViewModel.Voucher != null) _dgcode = vaucherViewModel.Voucher.DgCode;
        ...
        {
            _voucherStatusView = new VoucherStatusView { DataContext = _vaucherViewModel };
        ...
        {
            _dgcode = _vaucherViewModel.Voucher.DgCode;
        ...
        private void SetPaymentSetting(Service service, PaymentSetting p)
        {
            ...
            if (service.Voucher.Course != 1 && service is AviaService)
                lbPrice.Text = String.Format("{0}{1} ({2} руб)", paymentValue.ToString(RoundFormat), _rate, Math.Round(service.Voucher.Course * paymentValue, 2));
            else
            {
