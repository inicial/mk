...
{
    public partial class frmNewOptionsConfirmClose : Form
    {
        ...
        public frmNewOptionsConfirmClose(string text)
        {
            InitializeComponent();

            string msg = "Вы  изменили  данные.";
            msg = msg + (char)13 + (char)10;
            msg = msg + (char)13 + (char)10;
            msg = msg + "Закрыть  без  сохранения  изменений ?";
            msg = msg + (char)13 + (char)10;
