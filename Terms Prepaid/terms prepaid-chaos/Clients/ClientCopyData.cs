...
{
    public partial class ClientCopyData : Form
    {
        ...
        long MANAGER_ID;
        int client1,  client2;
        public ClientCopyData()
        {
            InitializeComponent();
        }
        public ClientCopyData(int client1, int client2, long MANAGER_ID, SqlConnection connection)
        {
            InitializeComponent();
        ...
        public void SaveClientData()
        {
            ...
            if (clientsDT.Rows.Count == 2)
            {
                ...
                adapter.SelectCommand = new SqlCommand("select * from clients where CL_KEY=" + Convert.ToString(clientUpdate), connection);
