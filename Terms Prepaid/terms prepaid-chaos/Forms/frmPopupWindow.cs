...
namespace terms_prepaid.Forms
{
    public partial class frmPopupWindow : Form, IResourceInterceptor
    {
        ...
        private Action<bool> _setVisibleStateHandler;
        ...
        public frmPopupWindow(Uri targetURL, Action<bool> setVisibleStateHandler = null)
        {
            // Initialize the core and get a WebSession.
            WebSession session = InitializeCoreAndSession();
            ...
            // Initialize a new view.
            InitializeView(WebCore.CreateWebView(this.ClientSize.Width, this.ClientSize.Height - 20, session), false, targetURL);

            if (setVisibleStateHandler != null)
                _setVisibleStateHandler = setVisibleStateHandler;
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if(_setVisibleStateHandler != null) 
                _setVisibleStateHandler.Invoke(_visibleState);

            changeVisibleStateBtn.Text = _visibleState ? "Скрыть" : "Показать";
        }
    }
}
