...
namespace WpfControlLibrary.ViewModel
{
    ...
    public class RequestMessagesViewModel : ViewModelBase, IRequestMessagesViewModel
    {
        ...
        public void Update(Request request)
        {
            ...
            //Request.Messages = new ObservableCollection<RequestMessage>(_requestMessagesHelper.GetMessages(Request.Number));
        ...
        /*
        protected void NewMessage(RequestMessageViewModel requestMessageViewModel)
        {
